			...
			<div class="main-content">
                <div class="conteudo">
                    <div class="conteudo-layout3">
						...
						<form id="usuario" class="kt-form kt-margin-t-10" method="POST" action="{{ route('cadastrar.clientes.salvar') }}" enctype="multipart/form-data">
							@csrf
							...
							<div class="bloco2">
								<div class="inputs">
									...
									<div class="form-group mb-4">
										...
										<input type="text" class="inputform" name="name" id="name">
									</div>
									<div class="form-group mb-4">
										<span for="email">EMAIL:</span>
										<input type="text" class="inputform" name="email" id="email">
									</div>
									<div class="form-group mb-4">
										<span for="cpf">CPF:</span>
										<input type="text" class="inputform" name="cpf" id="cpf">
									</div>
									<div class="form-group mb-4">
										<span for="telefone">TELEFONE:</span>
										<input type="text" class="inputform" name="telefone" id="telefone">
									</div>
								...
								<div class="inputs">
									<div class="form-group mb-4">
										...
										<input type="text" class="inputform" name="nascimento" id="nascimento">
									</div>
									<div class="form-group mb-4">
										<span for="cidade">CIDADE:</span>
										<input type="text" class="inputform" name="cidade" id="cidade">
									</div>
									<div class="form-group mb-4">
										<span for="endereco">ENDEREÇO:</span>
										<input type="endereco" class="inputform" name="endereco" id="endereco">
									</div>
									<div class="form-group mb-4">
										<span for="nmr_endereco">Nº da casa:</span>
										<input type="text" class="inputform" name="nmr_endereco" id="nmr_endereco">
									</div>
									<div class="form-group mb-4">
										<span for="bairro">BAIRRO:</span>
										<input type="text" class="inputform" name="bairro" id="bairro">
									</div>
								</div>
							</div>
							...
							<div class="carro">
								...
								<div class="inputs-carros">
									<div class="form-group mb-4">
										...
										<input type="text" class="inputform2" name="marca" id="marca">
									</div>
									<div class="form-group mb-4">
										<span for="modelo">MODELO:</span>
										<input type="text" class="inputform2" name="modelo" id="modelo">
									</div>
									<div class="form-group mb-4">
										<span for="ano">ANO:</span>
										<input type="text" class="inputform2" name="ano" id="ano">
									</div>
									<div class="form-group mb-4">
										<span for="placa">PLACA:</span>
										<input type="text" class="inputform2" name="placa" id="placa">
									</div>
								</div>
	
								<div class="kt-form__actions">
									<button type="submit" class="btn btn-brand">Cadastrar cliente</button>
								</div> 
							</div>
						</form>
