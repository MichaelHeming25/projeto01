...
<head>
	<title>Dashboard | Informações</title>
	<meta charset="utf-8">
			...
			<div class="main-content">
                <div class="conteudo">
                    <div class="conteudo-layout3">
						...
						<form id="usuario" class="kt-form kt-margin-t-10" method="POST" action="" enctype="multipart/form-data">
							@csrf
							...
							<div class="bloco2">
								<div class="inputs">
									...
									<div class="form-group mb-4">
										...
										<input type="text" class="inputform" name="name" id="name" value="{{$name}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="email">EMAIL:</span>
										<input type="text" class="inputform" name="email" id="email" value="{{$email}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="cpf">CPF:</span>
										<input type="text" class="inputform" name="cpf" id="cpf" value="{{$cpf}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="telefone">TELEFONE:</span>
										<input type="text" class="inputform" name="telefone" id="telefone" value="{{$telefone}}" readonly=“true”>
									</div>
								...
								<div class="inputs">
									<div class="form-group mb-4">
										...
										<input type="text" class="inputform" name="nascimento" id="nascimento" value="{{$nascimento}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="cidade">CIDADE:</span>
										<input type="text" class="inputform" name="cidade" id="cidade" value="{{$cidade}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="endereco">ENDEREÇO:</span>
										<input type="endereco" class="inputform" name="endereco" id="endereco" value="{{$endereco}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="nmr_endereco">Nº da casa:</span>
										<input type="text" class="inputform" name="nmr_endereco" id="nmr_endereco" value="{{$nmr_endereco}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="bairro">BAIRRO:</span>
										<input type="text" class="inputform" name="bairro" id="bairro" value="{{$bairro}}" readonly=“true”>
									</div>
								</div>
							</div>
							...
							<div class="carro">
								...
								<div class="inputs-carros">
									<div class="form-group mb-4">
										...
										<input type="text" class="inputform2" name="marca" id="marca" value="{{$marca}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="modelo">MODELO:</span>
										<input type="text" class="inputform2" name="modelo" id="modelo" value="{{$modelo}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="ano">ANO:</span>
										<input type="text" class="inputform2" name="ano" id="ano" value="{{$ano}}" readonly=“true”>
									</div>
									<div class="form-group mb-4">
										<span for="placa">PLACA:</span>
										<input type="text" class="inputform2" name="placa" id="placa" value="{{$placa}}" readonly=“true”>
									</div>
								</div>
