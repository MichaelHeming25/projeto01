                              ...
                              <tbody>
                                @for ($i = 0; $i < sizeof($user); $i++)
                                  <tr>
                                    ...
                                    <td>
                                      <div class="botoes">
										<button type="button" class="botao-editar" style="margin-right: 10px;" onclick="javascript:location.href='usuarios/editar/{{ $user[$i]['id'] }}'"><span class="entypo-tools"><i class="fas fa-edit"></i></span></button>
                                        <button type="button" class="botao-remover" onclick="javascript:location.href='usuarios/remover/{{ $user[$i]['id'] }}'"><i class="far fa-trash-alt"></i></button>  
                                      </div>
									</td>
